...
- **地基**：有了主機與網域、設定 DNS、上了 SSL 加密與 CDN
- **裝潢**：跑**安裝精靈**把 WordPress 啟動上線、進了後台
- **佈置**：確認語言時區、發佈**第一篇文章**、建立「**關於我**」頁面與**選單**、換上喜歡的**佈景主題**

<div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
<b>開機檢查</b>：現在花 5 分鐘打開自己的子網域，確認前台打得開、後台 (<code>/wp-admin</code>) 登得進去。
</div>
...
| 15:00 – 17:00 | 第 05 堂 (4)：WooCommerce 電商、Sensei 線上課程 |
...
<!--
App 商店＝外掛目錄、App 更新＝外掛更新、App 太多手機變慢＝外掛太多網站變慢。
...
<!--
舉例：期末發「成績查詢公告」，用數據確認八成家長都看過了，沒看的再用 LINE 補通知。
-->
...
<!--
今天設定完報表是空的，這不是壞掉。可展示講師自己網站的報表畫面當範例。
...
<!--
先問現場：有多少已經在用 Google 表單？

通常很多。所以先講方法一，銜接他們既有的習慣。
-->
...
<!--
重點訊息：「不是你重不重要，是機器人無差別掃描」。

很多人會覺得「我的小網站誰要駭」，錯，機器人不挑食。
...
WordPress 後台還進得去 → 用 UpdraftPlus 還原最方便。

整個 WordPress 掛到進不了後台 → 用 Cloudways 主機層還原。
...
「門面級」頁面 (首頁、招生頁、活動頁) 才出動 Elementor。
...
新手最常有的疑問：我已經有佈景主題了，為什麼還需要它？

- 🎨 **佈景主題**：管**全站**的統一外觀，頁首、頁尾、選單、預設字體與配色
- 🧩 **Elementor**：管**單一頁面**裡的排版，這一頁想怎麼設計都行
- 兩者是**分工，不是取代**：主題像制服，Elementor 是你在自己頁面裡的自由發揮

<div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
<b>設定幾乎不用動</b>：Elementor 裝好照預設就能用，首次引導一路「下一步」即可，之後都能改。
</div>

<!--
這頁的目的是消除「已經有主題了幹嘛還要 Elementor」的困惑，講清楚「分工不是取代」即可，設定細節不用停留。
...
1. 編輯單元 → 點內容區的「**+**」→ 找到「**Quiz**」區塊，點下去插入
2. 測驗區塊裡再點「**+**」→ 新增題目：選擇題、是非題、填空等題型
3. 設定正確答案與及格分數
4. 學生作答後自動批改 (選擇題類)
...
「Quiz」區塊有時會直接出現在「+」打開後的預設常用選項裡 (段落、圖片、YouTube 嵌入內容、Quiz、Course Progress、Course Signup)，沒看到也別慌，打字搜尋「Quiz」一定找得到，這是最容易讓學員卡關的地方，強調一下。
-->
