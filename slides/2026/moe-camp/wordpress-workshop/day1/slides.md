...
<!--
第一點的概念業界稱為 GEO (生成式引擎最佳化)，是 SEO 的下一步，有興趣的人可以口頭補充，不用特別寫進投影片增加負擔。
-->
...
| 天數 | 主題 | 你會得到什麼 |
|------|------|--------------|
| **Day 1** | 架站基礎到佈景主題 | 一個 WordPress 網站、換上佈景主題 |
...
按下「建立伺服器」之類的按鈕後，依序做這些選擇：

1. 應用程式選 **WordPress** (最新版)，系統會幫你裝好
2. 雲端供應商用**預設入門款**即可，夠用就好
3. 方案大小選**最小方案**，個人網站綽綽有餘
4. 機房位置選**新加坡或東京**，離台灣近、速度快
5. 幫伺服器與應用程式取個名字 (英文即可)，確認後送出
6. **等待數分鐘**讓系統建置
...
AAAA＝更長更精細的 GPS (IPv6)

CNAME＝「北車」是台北車站的暱稱 (別名指向真正的名字)

MX＝郵箱 (決定信寄到哪)

TXT＝便條紙 (常用於網域驗證、SPF 防偽造寄件)。
...
也請學員把這個 /wp-admin 網址加入書籤，之後常會用到。
-->
...
<!--
語言在安裝精靈就選過繁體中文了，這裡主要是「確認」沒選錯；真正要動手改的是**時區**，務必改成台北 (UTC+8)。
...
「分類和標籤一定要設嗎？」不設也能發佈，WordPress 會自動歸入「未分類」。
-->
