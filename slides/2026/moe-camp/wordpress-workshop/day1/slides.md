...
# 先問一個問題：現在都有 AI 了，還需要網站嗎？

- 想查資料，問 ChatGPT；想找答案，問 AI 助理
- 好像什麼都能問 AI，沒人會特地打開一個網站了？
- 這是很多人開始這堂課前，心裡真正的疑問

<v-click>

> 答案：不只需要，而且是 **AI 時代更需要**

</v-click>

<!--
開場前先讓這個疑慮被講出來，比假裝大家都很有動機更誠實，也更有說服力。
可以現場問一句：「有人是抱著這個疑問來的嗎？」通常會有人舉手，順勢帶入下一頁。
-->
...
- **AI 找資料也要有「來源」**：ChatGPT、Google 這類工具回答問題時，是去讀網路上真實存在的網站內容，整理後才告訴你 — 沒有網站，AI 手上就沒有你的東西可以引用、推薦
- **網站是你自己的地盤**：社群貼文、AI 對話紀錄都不是你的資產；網站的網域、內容、累積的搜尋排名全部歸你，換平台、換演算法都不怕
- **搜尋你的名字，要有東西**：合作對象、陌生人搜尋你時，一個專業網站 vs 什麼都沒有，可信度差很多

</v-clicks>

<!--
這頁資訊量偏大，放慢講，可以每點停一下問「有沒有共鳴？」。
第一點的概念業界稱為 GEO (生成式引擎優化)，是 SEO 的下一步，有興趣的人可以口頭補充，不用特別寫進投影片增加負擔。
-->
...
- **AI 認識你的方式，由你的網站決定**：以後大家問 AI「這個人是誰、這家店怎麼樣」，AI 的答案很大程度來自它讀過什麼。你不寫，AI 對你的認識就是零，或是別人（負評、八卦、競爭對手）幫你寫的版本
- **網域的信任分數，會複利**：AI 判斷內容可不可信，會參考網域存在多久、累積了多少連結，這是舊 SEO 概念，在 AI 時代被重新拿來用。越早架站，越早開始累積這筆會生利息的信任資產，晚開始真的追不上
- **AI 農場文氾濫，真人經驗反而稀缺**：AI 寫文章的成本趨近於零，網路正被灌爆 AI 垃圾文。Google 和 AI 系統反而要更用力篩選「真的是人寫、有第一手經驗」的內容。滿地都是 AI 文的時候，你的真實經驗變貴重了

</v-clicks>

<!--
這三點比較進階，是給有在關注 AI 產業動態的學員的「彩蛋」，講快一點沒關係，重點是製造「原來還有這一層」的驚訝感。
不用逐字唸過每個名詞（E-E-A-T、domain authority），意思到就好，太深入反而模糊焦點。
-->
...
- 以前架站：要學程式、學設計，燒好幾個禮拜
- 現在：AI 幫你寫文案、抓靈感，甚至幫你寫外掛功能
- 這三天要做的事：**教學 4.0，用 AI 打造你的自動化數位職人官網**
- 用最少的力氣，做出最好的網站

<v-click>

<div class="mt-6 max-w-lg mx-auto border-l-4 border-[#0073aa] bg-blue-50 dark:bg-blue-900 px-4 py-3 text-left">
現在，就是最好的時機。
</div>
...
<!--
呼應整個工作坊的主題，把「為什麼」順勢接到「怎麼做」，情緒上是這段開場最重要的轉場。
接下來就進入三天學習地圖，正式介紹課程內容。
-->
 ...
 **今天很重要！** Day 1 是地基，後面兩天都建立在今天的成果上。
...
<v-click>
 ...
 今天用**已經建立好的伺服器**實作，不需要信用卡、也不用先註冊任何服務。

</v-click>

<!--
常見狀況：
1. 學員只帶平板，填資料庫、經營後台會很辛苦，盡量協助借筆電。
2. LLM 服務用 Claude／Gemini／ChatGPT 免費版即可，Day 3 用 AI 做功能時會用到，請學員先登入備妥。
3. 強調：今天不用花錢、不用綁卡，講師會發給每位伺服器與子網域的連線資訊。
-->
...
<!--
建立「卡關就舉手」的文化很重要，很多人會不好意思發問。
Discord：開場就請全班一起掃 QR 加入，當三天的即時後盾 (課堂問答、作業、分享成果)，加入率最高。
-->
...
| 10:00–12:00 | **第 02 堂** 啟動 WordPress 網站 |
| 12:00–13:00 |  午餐 |
...
<!--
這張圓餅圖用程式畫，數據是 2026 年 6 月 W3Techs 的「佔所有使用 CMS 網站」比例，可隨時更新數字。
WordPress 59.3% 遙遙領先第二名 Shopify (7.5%)，視覺上一目了然。
注意兩個數字的差別：「41.5%」是占「所有網站」(含未用 CMS 的) ；「近 6 成 (59.3%)」是占「有用 CMS 的網站」，也就是圖表畫的這個。
...
學員真正動手的是用講師開好的伺服器與子網域 (WordPress 核心已預先上傳)，跑安裝精靈完成安裝。
示範段節奏可快一點，把時間留給學員實作安裝精靈。
-->
...
| 型態 | 概念 | 適合 |
|------|------|------|
| **虛擬** | 跟很多人合租一間房 | 預算極低、流量小 |
| **雲端 (VPS)** | 自己租一間套房 | 彈性大，但要自己管系統 |
| **託管式雲端** | 租套房 + 有管家 | 新手友善、不用自己顧系統 |


<!--
不用深入技術細節，重點是讓學員理解「為什麼不選最便宜的」：
時間寶貴，託管式把系統管理的苦工外包掉，才能專心經營內容。
-->
...
<div class="flex items-stretch gap-2 text-sm">
  <div class="w-44 rounded-lg border-2 border-[#0073aa] bg-white overflow-hidden text-center">
    <div class="bg-[#0073aa] text-white font-bold py-1.5">瀏覽器</div>
    <div class="px-3 py-3 text-gray-600">輸入網址<div class="font-mono text-[#0073aa] mt-1">example.tw</div></div>
  </div>
  <div class="flex flex-col items-center justify-center px-1 text-[#0073aa]">
    <div class="text-3xl leading-none">→</div>
    <div class="text-xs text-gray-400 mt-1">查 IP</div>
  </div>
  <div class="w-44 rounded-lg border-2 border-[#0073aa] bg-white overflow-hidden text-center">
    <div class="bg-[#0073aa] text-white font-bold py-1.5">DNS</div>
    <div class="px-3 py-3 text-gray-600">查出 IP 位址<div class="text-xs text-gray-400 mt-1">像查電話簿</div></div>
  </div>
  <div class="flex flex-col items-center justify-center px-1 text-[#0073aa]">
    <div class="text-3xl leading-none">→</div>
    <div class="text-xs text-gray-400 mt-1">連線</div>
  </div>
  <div class="w-44 rounded-lg border-2 border-[#0073aa] bg-white overflow-hidden text-center">
    <div class="bg-[#0073aa] text-white font-bold py-1.5">伺服器</div>
    <div class="px-3 py-3 text-gray-600">伺服器<div class="text-xs text-gray-400 mt-1">WordPress 產生網頁</div></div>
  </div>
</div>

<div class="relative mt-3 h-5">
  <div class="absolute inset-x-0 top-2 border-t-2 border-dashed border-[#0073aa] opacity-40"></div>
  <div class="absolute inset-x-0 top-0 flex justify-center">
    <span class="bg-white px-2 text-xs text-[#0073aa]">← 伺服器把產生好的網頁傳回給訪客</span>
  </div>
</div>
...
<v-click>
 ...
 今天已經幫大家建好**伺服器、子網域和資料庫**，並**預先上傳好 WordPress 核心**。
...
強調：學員今天不用自己註冊 Cloudways，直接用講師開好的伺服器與子網域跑安裝精靈，省去等待與綁卡的時間。
-->
...
<!--
這是示範，學員看流程即可，不用跟著註冊。
示範時順帶提醒回家自己做會遇到的狀況：驗證信可能跑到垃圾郵件、學校 Email 可能擋信建議用 Gmail、部分帳號需要人工審核。
節奏可快，重點是讓學員知道「伺服器怎麼來」，把時間留給後面的安裝精靈實作。
-->
...
<!--
這是示範，介面選項名稱可能隨改版變動，講「要找什麼」而不是「按哪裡」。
強調機房選錯 (例如選到美國) 網站會明顯變慢，這是回家自己開伺服器時的重點提醒。
-->
...
<!--
這是示範。建置要等 5-10 分鐘，正好利用這段時間預告下一節「網域」的概念，不要乾等。
命名建議用好辨識的英文，例如 mysite、classweb，避免中文，這也是回家自己開伺服器時的小訣竅。
-->
...
<!--
這是示範，學員看流程即可。為什麼選 Gandi：有中文介面、價格透明、附贈信箱服務。
也可順帶提：GoDaddy、Namecheap 等都是同類服務，原理相同。
聯絡資訊要填真實的，這是國際網域註冊規範 (WHOIS) 要求，回家自己註冊時要注意。
-->
...
<!--
這是示範，學員今天不用刷卡買網域。示範時點出回家自己買會遇到的狀況：
1. 想要的名字被註冊了，要換結尾或微調名字，所以事先想好備案。
2. 結帳會用信用卡，可能遇到 3D 驗證簡訊或額度問題。
3. 注意隱私保護 (WHOIS 隱私) 選項，Gandi 多半預設提供。
強調：今天學員的網站是放在講師開好的子網域上，不需要自己購買網域。
-->
...
<span class="inline-block text-xs font-bold text-white rounded px-2 py-0.5" style="background:#64748b">示範</span> 買好網域後，要讓它指向伺服器：
...
> 今天只會用到 **A 紀錄**，把網域指到伺服器 IP，其他先認得就好
...
<!--
這是示範。提醒回家自己做時常見的錯：網域打錯字 (少打字母、多打 www)，建議從 Gandi 帳號複製貼上。
此時網站還連不上新網域是正常的，因為 DNS 那一半還沒設定，先講清楚這個順序。
-->
...
<!--
這是示範，也是回家自己架站最容易出錯的一頁：
1. IP 抄錯一個數字，要從 Cloudways 複製貼上。
...
<!--
這是示範的成果，學員不用自己操作 (你們的網站已經在講師開好的子網域上)。
...
<!--
這是示範。回家自己做時的提醒：
1. 方案頁面把付費方案放很顯眼，免費方案在下面，記得找 Free。
2. 自動掃描通常會帶入剛剛設的 A 紀錄，要核對 IP 是否正確。
-->
...
<!--
這是示範。等待時間不定，從幾分鐘到數小時，所以講師建議準備一個已生效的帳號，直接示範後續步驟，不用現場乾等。
順勢說明：這也是今天不讓學員各自接網域與 Cloudflare 的原因，等待太花時間，回家有空再慢慢做。
-->
...
- 一定要選 Full。若官網介面提供 Full (Strict)，搭配 Cloudways 的憑證也可以。
-->
...
<!--
這是示範的最終成果，讓學員看到「自己架站」最後長什麼樣子。
強調：學員的子網域現在就是活的 (等一下實作環節跑安裝精靈就會看到)，網域/SSL 是回家自己架站時才需要的進階知識，今天不用做。
-->
...
這節純示範，是回家自己架站時的知識，不影響今天學員的安裝精靈主線。
-->
...
# 實作：跑安裝精靈，完成你的 WordPress

<span class="inline-block text-xs font-bold text-white rounded px-2 py-0.5" style="background:#0073aa">實作 · 約 10 分鐘</span>

**換你動手了！** **WordPress 核心已經幫大家上傳好了**，你只要跑「安裝精靈」把它啟動起來。

你會拿到一張**帳密表**，上面有：

- **你的專屬子網域** (例如 `你的代號.ericwu.asia`)
- **資料庫資訊** (DB 名稱、使用者、密碼、主機)

<v-click>

接下來三步：**開啟安裝精靈 → 填資料庫資訊 → 設定站台與管理員**

</v-click>

<!--
原本這裡要教 FTP 上傳，但全班同時上傳容易把伺服器塞爆，所以講師已先幫每個人把 WordPress 傳好。
今天學員只要專心把安裝精靈跑完就好，難度更低、時間更省，不用學 FTP。
先把三步驟的全景講一次，學員才知道自己在哪一步。
請先確認每位都拿到自己的帳密表 (子網域 + 資料庫資訊) 再開始。
-->
...
1. 瀏覽器打開**你的子網域** (例如 `https://s07.ericwu.asia`)
2. 因為還沒設定，會**自動進入 WordPress 安裝精靈**
3. 語言選 **繁體中文**，按「繼續」
4. 讀完「待會需要資料庫資訊」的說明，按「**開始執行**」

<div class="mt-6 max-w-xl mx-auto border-l-4 border-[#0073aa] bg-blue-50 px-4 py-3 text-left">
把網址列的<b>代號</b>換成帳密表上你自己的，例如帳密表寫 <code>s07</code>，網址就是 <code>https://s07.ericwu.asia</code>。
</div>

<!--
子網域 = 你的代號.ericwu.asia，代號在帳密表上，每個人不一樣，別互相打錯。
若打開看到的是已經裝好的網站 (不是安裝精靈)，多半是網址代號打錯了別人的，請重新確認。
語言記得選「繁體中文」，之後整個後台都會是中文。
-->
...
照著**帳密表**把四個欄位填好 (以代號 `s07` 為例)：

| 欄位 | 填入 | 範例 (代號 s07) |
|------|------|------|
| 資料庫名稱 | `wp_` + 你的代號 | `wp_s07` |
| 使用者名稱 | 你的代號 | `s07` |
| 密碼 | 帳密表上的資料庫密碼 | 見帳密表 |
| 資料庫主機 | 固定填 | `localhost` |

<div class="mt-4 text-sm text-gray-500">資料表前綴維持預設 <code>wp_</code> 即可，填完按「送出」。</div>

<!--
最常見卡關就是這頁：請學員一律用「複製貼上」，不要手打，尤其密碼。
資料庫名稱、使用者名稱都用自己的代號代入，別照抄 s07；主機固定 localhost。
出現「無法連線到資料庫」= 四個欄位有一格貼錯，逐格對帳密表重貼。
-->
...
1. **站台標題**：你的網站名稱 (之後可改)
2. **管理員帳號與密碼**：**務必記下來！** Day 2、Day 3 都要用
3. 填入你的 **Email**
4. 按「**安裝 WordPress**」，看到成功畫面就完成了

<div class="mt-5 max-w-xl mx-auto border-l-4 border-green-500 bg-green-50 px-4 py-3 text-left">
安裝成功後，之後所有操作都在 <code>你的子網域/wp-admin</code>，例如 <code>https://s07.ericwu.asia/wp-admin</code>。
</div>

<!--
管理員帳號密碼是今天最重要的東西，請學員寫在紙上或記事本，弄丟就要重設很麻煩。
帳號不要用 admin (資安不良示範)，改用自己的英文名或代號。
成功畫面按「登入」就會到 wp-admin 登入頁，銜接下一頁的進度檢查站。
-->
...
卡關的學員：多半是資料庫四欄有一格貼錯、或代號打成別人的，逐一協助。
先完成的學員可先逛逛後台，或當小助教。
-->
...
從現在開始，經營網站的一切都在 **`你的子網域/wp-admin`** 完成：

- **佈景主題、外掛**：後台直接**搜尋安裝**，或**上傳 zip** 檔安裝
- **文章、頁面、圖片**：都在後台新增與管理，全程不用寫程式
- **上傳限制**：單一檔案（圖片、外掛 zip）上限 **64MB**

<div class="mt-5 max-w-xl mx-auto border-l-4 border-[#0073aa] bg-blue-50 px-4 py-3 text-left">
今天不用碰伺服器。<b>記住後台網址、記住管理員帳密</b>，就能隨時回來經營網站。
</div>

<!--
建立「後台就是家」的心智模型：Day 2 換佈景、裝外掛，Day 3 做功能，全都回到這個 wp-admin。
強調兩個要記住的東西：後台網址 (子網域/wp-admin) 與管理員帳密。
64MB 是這台伺服器設定的上傳上限，之後若遇到「主題/外掛 zip 太大傳不上去」就是撞到這個限制，先知道有這回事。
佈景主題與外掛的實際操作留到第 04 堂與 Day 2 再帶，這頁先讓學員知道「都在後台、可搜尋可上傳」。
-->
...
<div class="w-fit mx-auto mt-4 text-sm space-y-1">

  <div class="flex items-center gap-3 w-[540px] rounded-lg border border-gray-300 bg-white px-4 py-2 shadow-sm">
    <div class="w-10 text-center text-[#0073aa] font-bold">保全</div>
    <div class="flex-1">
      <div class="font-bold text-[#0d324d]">Cloudflare (SSL + CDN) </div>
      <div class="text-xs text-gray-400">名稱伺服器接管、Full 模式加密</div>
    </div>
    <span class="inline-block text-xs font-bold text-white rounded px-2 py-0.5" style="background:#64748b">示範</span>
  </div>

  <div class="text-center text-gray-300 text-lg leading-none">↓</div>

  <div class="flex items-center gap-3 w-[540px] rounded-lg border border-gray-300 bg-white px-4 py-2 shadow-sm">
    <div class="w-10 text-center text-[#0073aa] font-bold">門牌</div>
    <div class="flex-1">
      <div class="font-bold text-[#0d324d]">Gandi (網域) </div>
      <div class="text-xs text-gray-400">A 紀錄 → 指向伺服器 IP</div>
    </div>
    <span class="inline-block text-xs font-bold text-white rounded px-2 py-0.5" style="background:#64748b">示範</span>
  </div>
  ...
  <div class="flex items-center gap-3 w-[540px] rounded-lg border border-gray-300 bg-white px-4 py-2 shadow-sm">
    <div class="w-10 text-center text-[#0073aa] font-bold">房子</div>
    <div class="flex-1">
      <div class="font-bold text-[#0d324d]">Cloudways (伺服器) </div>
      <div class="text-xs text-gray-400">伺服器與子網域</div>
    </div>
    <span class="inline-block text-xs font-bold text-white rounded px-2 py-0.5" style="background:#64748b">示範</span>
  </div>
  ...
  <div class="flex items-center gap-3 w-[540px] rounded-lg border-2 border-[#0073aa] bg-white px-4 py-2 shadow">
    <div class="w-10 text-center text-[#0073aa] font-bold">內容</div>
    <div class="flex-1">
      <div class="font-bold text-[#0d324d]">WordPress (你的網站) </div>
      <div class="text-xs text-gray-400">你親手跑安裝精靈裝起來</div>
    </div>
    <span class="inline-block text-xs font-bold text-white rounded px-2 py-0.5" style="background:#0073aa">實作</span>
  </div>

</div>

<div class="text-center mt-3 font-bold text-[#0d324d]">每一層各司其職：保全 → 門牌 → 房子 → 內容</div>

<!--
對照第 01 堂的架構圖：上面三層 (保全/門牌/房子) 今天由示範，回家自己架站時就是照這個流程做；
最底層「內容」WordPress 是學員今天親手跑安裝精靈裝起來的 (核心檔案講師已先上傳好)。
...
1.  **資料庫連線錯誤**，DB 名稱/使用者/密碼/主機有一格貼錯，逐格對帳密表重貼、主機固定 `localhost`
2.  **打開看到的是別人已裝好的網站**，網址代號打成別人的，重新確認自己的代號
3.  **打開一片空白或報錯**，多半還是資料庫四欄填錯，重新核對帳密表
4.  **代號、密碼建議用複製貼上**，不要手打，避免大小寫或看錯字元


<!--
這是今天學員實作最可能卡關的地方，請講師與助教重點巡這四項。
最常見：資料庫四欄有一格貼錯 (尤其密碼)、以及網址代號打成別人的。
提醒學員一律複製貼上、別照抄範例的 s07。
-->
...
<!--
比喻：前台是店面，後台是辦公室兼倉庫。
忘記帳密的學員：就是安裝精靈步驟 3 自己設的管理員帳密，請回想或舉手協助。
下一頁就會實際輸入 /wp-admin 網址登入。
-->
...
2. 因為安裝精靈第一步就選了繁體中文，登入後應該已經是中文介面；若還是英文，多半是安裝時語言選錯，下一頁的「確認語言與時區」可以補救。
提醒：管理員密碼之後可以在「使用者」裡改成自己好記的；也請學員把這個 /wp-admin 網址加入書籤，之後常會用到。
-->
...
<!--
語言在安裝精靈就選過繁體中文了，這裡主要是「確認」沒選錯；真正要動手改的是**時區**。
時區常被忽略，但會影響文章顯示時間和預約發佈，務必改成台北 (UTC+8)。
...
|---|---|---|
| 比喻 | 大抽屜 | 小貼紙 |
| 一篇文章 | 通常屬於**一個** | 可以貼**很多個** |
| 例子 | 教學筆記、班級活動、公告 | 段考、校外教學、108 課綱 |
...
<div class="rounded-lg border border-gray-300 overflow-hidden shadow text-xs bg-white mt-6">
  <div class="bg-[#0073aa] text-white px-3 py-2 flex items-center justify-between">
    <span><b>頁首</b>｜網站標題</span>
    <span class="opacity-90">首頁・關於我・文章</span>
  </div>
  <div class="px-4 py-5 space-y-2">
    <div class="text-[10px] text-gray-400 mb-1">內容區 (文章 / 頁面) </div>
    <div class="h-2.5 w-2/3 bg-gray-200 rounded"></div>
    <div class="h-2 w-full bg-gray-100 rounded"></div>
    <div class="h-2 w-full bg-gray-100 rounded"></div>
    <div class="h-2 w-4/5 bg-gray-100 rounded"></div>
    <div class="h-14 w-full bg-gray-100 rounded mt-2"></div>
  </div>
  <div class="bg-gray-100 text-gray-500 px-3 py-2 border-t flex items-center justify-between">
    <span><b>頁尾</b>｜© 2026 我的網站</span>
    <span class="opacity-70">關於・聯絡</span>
  </div>
</div>

<div class="text-xs text-gray-400 text-center mt-2">同一個外框，套用在每一頁</div>

<!--
網站編輯器 (Site Editor) 僅在區塊佈景主題下可用，預設佈景主題支援。
先講概念即可，等一下第 04 堂換好佈景主題、實際操作網站編輯器時，會順便把「關於我」加進選單。
...
2. 關鍵字搜尋，挑 **2–3 個候選**，滑鼠移上去可**即時預覽**比較
...
<!--
給學員約 15 分鐘自由挑主題、安裝啟用，現場會很熱鬧。
巡場重點：
1. 有人安裝了沒按「啟用」，前台沒變，回去按啟用。
2. 啟用後首頁變空白，部分主題要在「外觀 → 自訂」設定首頁，協助處理或先換回預設主題。
...
<!--
提醒：不要去來路不明的網站下載「破解版」付費主題，常被植入惡意程式，這和前一頁「絕不裝破解主題」的安全守則一致。
-->
...
<div class="max-w-xl mx-auto mt-5 space-y-2">
  <div class="flex items-start gap-3 rounded-lg border border-gray-200 bg-white px-4 py-2.5 shadow-sm">
    ...
    <div><span class="font-bold text-[#0d324d]">WordPress 裝好了</span><span class="text-xs text-gray-400 ml-2">子網域打得開、能登入後台</span></div>
  </div>
  <div class="flex items-start gap-3 rounded-lg border border-gray-200 bg-white px-4 py-2.5 shadow-sm">
    <div class="w-5 h-5 rounded border-2 border-[#0073aa] shrink-0 mt-0.5"></div>
    <div><span class="font-bold text-[#0d324d]">發佈了第一篇文章</span><span class="text-xs text-gray-400 ml-2">前台看得到</span></div>
  </div>
  <div class="flex items-start gap-3 rounded-lg border border-gray-200 bg-white px-4 py-2.5 shadow-sm">
    <div class="w-5 h-5 rounded border-2 border-[#0073aa] shrink-0 mt-0.5"></div>
    <div><span class="font-bold text-[#0d324d]">發佈了一個頁面</span><span class="text-xs text-gray-400 ml-2">「關於我」掛在選單上</span></div>
  </div>
  <div class="flex items-start gap-3 rounded-lg border border-gray-200 bg-white px-4 py-2.5 shadow-sm">
    <div class="w-5 h-5 rounded border-2 border-[#0073aa] shrink-0 mt-0.5"></div>
    <div><span class="font-bold text-[#0d324d]">換上佈景主題</span><span class="text-xs text-gray-400 ml-2">網站有了新外觀</span></div>
  </div>
  <div class="flex items-start gap-3 rounded-lg border border-gray-200 bg-white px-4 py-2.5 shadow-sm">
    <div class="w-5 h-5 rounded border-2 border-[#0073aa] shrink-0 mt-0.5"></div>
    <div><span class="font-bold text-[#0d324d]">記住帳密</span><span class="text-xs text-gray-400 ml-2">子網域、後台管理員帳號密碼</span></div>
  </div>
</div>
...
<!--
安裝精靈沒跑完的學員：留下來協助，務必讓每位都能登入自己的後台。
...
2. **第 02 堂**：保全→門牌→房子→內容；你親手**跑安裝精靈**把 WordPress 啟動了。
