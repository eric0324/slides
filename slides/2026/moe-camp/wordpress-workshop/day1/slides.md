...
<!--
這是講師示範，介面選項名稱可能隨改版變動，講「要找什麼」而不是「按哪裡」。
...
<!--
這是講師示範。建置要等 5-10 分鐘，正好利用這段時間預告下一節「網域」的概念，不要乾等。
...
<!--
這是講師示範，學員看流程即可。為什麼選 Gandi：有中文介面、價格透明、附贈信箱服務。
...
<!--
這是講師示範，學員今天不用刷卡買網域。示範時點出回家自己買會遇到的狀況：
...
<!--
這是講師示範。提醒回家自己做時常見的錯：網域打錯字（少打字母、多打 www），建議從 Gandi 帳號複製貼上。
...
<!--
這是講師示範。等待時間不定，從幾分鐘到數小時，所以講師建議準備一個已生效的帳號，直接示範後續步驟，不用現場乾等。
...
<!--
這是講師示範。SMTP 全名不用背，比喻：網站自己寄信像「沒貼郵票亂投遞」，會被當垃圾信；
