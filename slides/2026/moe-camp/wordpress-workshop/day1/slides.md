...
<!--
時間為佔位，依實際課表調整。
第 02 堂節奏：網域/DNS/SSL 由示範，學員動手跑安裝精靈完成 WordPress (核心實作，WordPress 核心已由講師預先上傳)。
...
學員真正動手的是用講師開好的主機與子網域 (WordPress 核心已預先上傳)，跑安裝精靈完成安裝。
...
<div class="flex items-stretch gap-2 text-sm">
  ...
  <div class="w-44 rounded-lg border-2 border-[#0073aa] bg-white overflow-hidden text-center">
    ...
    <div class="px-3 py-3 text-gray-600">主機<div class="text-xs text-gray-400 mt-1">WordPress 產生網頁</div></div>
  </div>
</div>
...
<v-click>
 ...
 今天**講師已用 Cloudways 開好主機**，幫大家建好**子網域與資料庫**，並**預先上傳好 WordPress 核心**。
...
強調：學員今天不用自己註冊 Cloudways，直接用講師開好的主機與子網域跑安裝精靈，省去等待與綁卡的時間。
-->
...
節奏可快，重點是讓學員知道「主機怎麼來」，把時間留給後面的安裝精靈實作。
-->
...
強調機房選錯 (例如選到美國) 網站會明顯變慢，這是回家自己開主機時的重點提醒。
-->
...
命名建議用好辨識的英文，例如 mysite、classweb，避免中文，這也是回家自己開主機時的小訣竅。
-->
...
<!--
原本這裡要教 FTP 上傳，但全班同時上傳容易把主機塞爆，所以講師已先幫每個人把 WordPress 傳好。
...
今天不用碰主機。<b>記住後台網址、記住管理員帳密</b>，就能隨時回來經營網站。
</div>

<!--
建立「後台就是家」的心智模型：Day 2 換佈景、裝外掛，Day 3 做功能，全都回到這個 wp-admin。
強調兩個要記住的東西：後台網址 (子網域/wp-admin) 與管理員帳密。
64MB 是這台主機設定的上傳上限，之後若遇到「主題/外掛 zip 太大傳不上去」就是撞到這個限制，先知道有這回事。
...
<div class="w-fit mx-auto mt-4 text-sm space-y-1">
  ...
  <div class="flex items-center gap-3 w-[540px] rounded-lg border border-gray-300 bg-white px-4 py-2 shadow-sm">
    ...
    <div class="flex-1">
      ...
      <div class="text-xs text-gray-400">講師開好主機與子網域</div>
    </div>
    <span class="inline-block text-xs font-bold text-white rounded px-2 py-0.5" style="background:#64748b">示範</span>
  </div>
