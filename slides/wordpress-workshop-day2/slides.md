---
theme: default
title: WordPress 三日工作坊 Day 2：佈景主題與外掛生態
info: |
  教育部公民營計劃・WordPress 三日工作坊 Day 2。佈景主題挑選與安裝，以及表單、SEO、資安、備份、電商、線上課程等核心外掛實戰。
class: text-center
...
- ✅ Cloudways：我們的「雲端主機房」
- ✅ Gandi：買了一個自己的網域
- ✅ Cloudflare：DNS 與 SSL，網址前面有 🔒
- ✅ WordPress 後台：`你的網域/wp-admin`
- ✅ 發了第一篇文章、建了第一個頁面

<div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
🔍 <b>開機檢查</b>：用瀏覽器打開自己的網址，確認 <b>https://</b> 開頭、鎖頭正常、後台登得進去。
</div>

<!--
給 5 分鐘做開機檢查。常見狀況：
1. 忘記後台密碼 → 用「忘記密碼」寄信重設。
2. 網站打不開 → 先確認 Cloudways 伺服器沒有被停用（試用期問題）。
3. SSL 鎖頭異常 → 檢查 Cloudflare SSL 模式設定。
...
| 時間 | 內容 |
|------|------|
| 09:00 – 10:30 | 第 04 堂：佈景主題（挑選、安裝、啟用） |
| 10:30 – 10:40 | ☕ 休息 |
| 10:40 – 12:00 | 第 05 堂（上）：認識外掛、流量分析、表單、SEO |
| 12:00 – 13:00 | 🍱 午餐 |
| 13:00 – 14:50 | 第 05 堂（中）：圖片、資安、備份、Elementor |
| 14:50 – 15:00 | ☕ 休息 |
| 15:00 – 16:50 | 第 05 堂（下）：WooCommerce 電商、Sensei 線上課程 |
| 16:50 – 17:00 | Day 2 Checkpoint 與 Q&A |
...
讓網站 <span class="text-pink-500 font-bold">變漂亮</span> —— 佈景主題

讓網站 <span class="text-blue-500 font-bold">變強大</span> —— 外掛
...
💡 同樣一篇班級公告，換不同主題，版面、字體、顏色全部不一樣，但文字一個字都不會少。
</div>

</v-click>

<!--
學員常見焦慮：「換主題會不會把我寫的東西弄不見？」
回答：內容存在資料庫，主題只是外觀。但提醒：某些主題自帶的「首頁排版設定」換主題後會跑掉，內容本身不會消失。
-->
...
- 左右兩張是**同一個網站**，只是換了主題
- WordPress 官方目錄有上萬個免費主題可以選

<!--
如果有時間，可以現場 demo：在示範站切換兩個主題給大家看，視覺衝擊比截圖有效。
-->
...
<!--
提醒：按鈕的實際文字可能因 WordPress 版本略有不同（新增／安裝），認得位置比背文字重要。
常見卡關：學員搜尋中文關鍵字找不到主題 → 主題目錄以英文為主，建議搜英文關鍵字如 blog、education。
-->
...
- 安裝 ＝ 把衣服買回家放衣櫃
- **啟用** ＝ 真的穿上這件衣服
- 安裝完成後按鈕會變成「啟用」，點下去才會換裝
- 一次只能啟用**一個**主題
- 不確定好不好看？先點「**即時預覽**」，滿意再啟用

<div class="border-2 border-dashed border-gray-400 rounded-lg p-10 my-4 text-center text-gray-400">
📷 截圖：佈景主題啟用按鈕與啟用後的前台外觀
</div>

<!--
請學員啟用後立刻開新分頁看前台，感受「換裝」的瞬間。
常見問題：「可以同時用兩個主題嗎？」→ 不行，一次一個；但可以安裝很多個備著。
鼓勵學員趁網站還年輕多試幾個主題——內容多了之後換主題，版面通常要重新微調。
-->
...
- 🔄 **更新頻率**：最近有更新嗎？超過一年沒更新的要小心
- ⭐ **評價與安裝數**：星等高、啟用安裝數多 ＝ 經過大量使用者驗證
- 🆘 **支援度**：支援論壇有人回覆嗎？作者活躍嗎？

<div class="border-2 border-dashed border-gray-400 rounded-lg p-10 my-4 text-center text-gray-400">
📷 截圖：主題詳細頁的更新日期、評價、安裝數位置
</div>

<!--
類比：挑主題像在網購挑商品——看銷量、看評價、看賣家是否還在營業。
-->
...
- ⚡ **速度**：主題越輕量，網站越快；功能塞太多的主題往往很肥
- 📱 **響應式（RWD）**：手機上也要好看——家長幾乎都用手機看
- 🧩 **相容性**：是否支援你打算用的外掛（如頁面編輯器、電商）
...
<!--
現場請大家拿手機掃自己的網站，體驗響應式。
補充：Google 搜尋排名也看重手機體驗，這會在 SEO 小節再呼應。
-->
...
- **簡潔優先**：資訊清楚比炫砲重要，家長要的是「快速找到公告」
- **部落格型主題**：班級日誌、學習歷程、活動紀錄都是「文章流」
- 首頁能放「最新文章」與「重要連結」的主題最實用
- 配色簡單、中文字體顯示正常（避免太細的英文字體）
- 可搜尋的關鍵字：`blog`、`education`、`school`、`clean`

<!--
分享真實案例：班級網站最常被打開的頁面是「聯絡簿／公告」，所以主題要讓最新文章一眼可見。
有學員會想做很華麗的形象網站——提醒他們下午的 Elementor 可以補足美感，主題選簡單的就好。
-->
...
🔧 <b>衝突排查心法</b>：網站突然怪怪的 → 回想「最近裝／更新了什麼」→ 把嫌疑外掛<b>停用</b>看看是否恢復 → 一次只動一個，找出兇手。
</div>
...
<div class="border-2 border-dashed border-gray-400 rounded-lg p-10 my-4 text-center text-gray-400">
📷 截圖：Site Kit 連結 Search Console / Analytics
</div>
...
- 校外教學回條、活動報名、家長意見調查……紙本收發又慢又容易掉
- 希望家長在網站上**直接填寫送出**，老師收到通知
...
<div class="border-2 border-dashed border-gray-400 rounded-lg p-10 my-4 text-center text-gray-400">
📷 截圖：Google 表單嵌入碼與 WordPress 自訂 HTML 區塊
</div>
...
- 😵 `https://你的網域/?p=123`
- 😊 `https://你的網域/contact-us/`

<v-click>

- 預設網址是一串看不懂的編號
- 改成 **Post name（文章名稱）** 結構：人看得懂、Google 也更喜歡
- 對等等要教的 **SEO** 有直接幫助

</v-click>

<!--
銜接：為什麼這時候講永久連結？因為「聯絡我們」頁面的網址值得是 /contact 而不是 ?p=123。
-->
...
<div class="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900 rounded-lg">
⚠️ 中文標題會產生中文網址，分享到 LINE 會變一長串亂碼——可在編輯文章時手動把「網址代稱」改成英文。
</div>

<!--
最佳時機就是建站初期改，網站經營久了再改會讓舊連結失效。
示範：把一篇文章的代稱（slug）從中文改成英文，如「校外教學報名」→ field-trip。
-->
...
<div class="mt-4 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
💡 換位思考：家長會在 Google 打什麼字來找這篇？那串字就是你的焦點關鍵字。
</div>
...
🏫 學校網站被駭上新聞，比網站壞掉嚴重得多。防護是必修，不是選修。
</div>
...
<div class="border-2 border-dashed border-gray-400 rounded-lg p-10 my-4 text-center text-gray-400">
📷 截圖：UpdraftPlus 遠端儲存選擇 Google Drive 與授權
</div>
...
⚠️ 還原會把網站<b>蓋回備份當下的狀態</b>，備份之後新增的內容會消失。
</div>
...
- 🍪 班級義賣：義賣品上架，家長線上下單
- 📚 自製教材／講義販售：知識變現的第一步
- 用通用工具自己管理訂單，不被平台抽成綁住

<v-click>

**WooCommerce**：WordPress 官方家族的電商外掛，全球市占最高，**免費版即可**開店

</v-click>

<!--
先聲明：學校場域的收費活動請遵循校內行政與會計規範，本節教的是「工具能力」，實際應用時的法規與校規由老師自行確認。
這一節是今天份量最重的小節，請大家專注。
-->
...
- 🎪 園遊會預購：商品＋庫存＋自取＋截止日（折扣價排程）
- 🍪 班級義賣：銀行轉帳＋訂單管理取代手抄登記
- 📚 教材販售：之後可研究「虛擬／可下載商品」賣 PDF 講義

<div class="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900 rounded-lg">
⚠️ 涉及收費請務必遵循校內行政、會計與相關法規；對外營業另有稅務議題，請先確認再上路。
</div>

<!--
再次強調合規提醒，這是對老師的保護。
「虛擬商品」是個很好的延伸自學方向：商品資料勾「虛擬」＋「可下載」，就能賣電子檔。
-->
...
| Elementor | 頁面設計 | 門面頁專用 |
| WooCommerce | 電商 | 義賣、預購 |
...
- ✅ 佈景主題已啟用，手機看起來正常
- ✅ 聯絡表單可以送出，後台收得到
- ✅ Yoast SEO 運作中，至少一篇文章設定焦點關鍵字
- ✅ 完成**至少一次完整備份**（含 Google Drive 遠端）
- ✅ 商店有**一個商品**，自己成功下過一張訂單
- ✅ 建立**一堂課程**（含一個單元）
...
- 🖼️🛡️💾 圖片、資安、備份：讓網站快、安全、毀不掉
- 🎨🛒🎓 Elementor、WooCommerce、Sensei：美編、開店、開課
...
<div class="mt-10 text-gray-400">
教育部公民營計劃・WordPress 三日工作坊<br>
講師：Eric Wu
</div>

<!--
散場前最後一句提醒：今晚回家若手癢亂玩把網站玩壞——沒關係，你已經會還原備份了。這就是今天最大的收穫。
-->
